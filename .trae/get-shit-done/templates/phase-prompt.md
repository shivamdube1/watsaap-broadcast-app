...
<!-- For checkpoint task examples and patterns, see @E:/watsaap broadcast/.trae/get-shit-done/references/checkpoints.md -->
...
See `E:/watsaap broadcast/.trae/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `E:/watsaap broadcast/.trae/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `E:/watsaap broadcast/.trae/get-shit-done/workflows/verify-phase.md` for verification logic.
