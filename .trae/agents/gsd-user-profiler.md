...
<reference>
@E:/watsaap broadcast/.trae/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `E:/watsaap broadcast/.trae/get-shit-done/references/user-profiling.md` to load:
