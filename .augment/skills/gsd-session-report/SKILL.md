...
<execution_context>
@E:/watsaap broadcast/.augment/get-shit-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @E:/watsaap broadcast/.augment/get-shit-done/workflows/session-report.md end-to-end.
</process>
