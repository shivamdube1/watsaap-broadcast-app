...
<reference>
@E:/watsaap broadcast/.opencode/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `E:/watsaap broadcast/.opencode/get-shit-done/references/user-profiling.md` to load:
