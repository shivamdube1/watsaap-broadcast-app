...
Reference full template: `E:/watsaap broadcast/.opencode/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `E:/watsaap broadcast/.opencode/get-shit-done/templates/state.md`.
