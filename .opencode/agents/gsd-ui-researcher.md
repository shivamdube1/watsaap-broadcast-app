...
Use template from `E:/watsaap broadcast/.opencode/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `E:/watsaap broadcast/.opencode/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "E:/watsaap broadcast/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
