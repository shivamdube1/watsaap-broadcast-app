...
<execution_context>
@E:/watsaap broadcast/.windsurf/get-shit-done/workflows/check-todos.md
</execution_context>
...
<process>
**Follow the check-todos workflow** from `@E:/watsaap broadcast/.windsurf/get-shit-done/workflows/check-todos.md`.
