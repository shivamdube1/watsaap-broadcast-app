...
<execution_context>
@E:/watsaap broadcast/.windsurf/get-shit-done/workflows/add-todo.md
</execution_context>
...
<process>
**Follow the add-todo workflow** from `@E:/watsaap broadcast/.windsurf/get-shit-done/workflows/add-todo.md`.
