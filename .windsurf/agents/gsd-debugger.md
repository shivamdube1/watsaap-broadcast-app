...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = E:/watsaap broadcast/.windsurf
                  → checks E:/watsaap broadcast/.windsurf/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = E:/watsaap broadcast/.windsurf/get-shit-done
                  → writes to E:/watsaap broadcast/.windsurf/get-shit-done/hooks/
...
@E:/watsaap broadcast/.windsurf/get-shit-done/references/thinking-models-debug.md
...
- Read @E:/watsaap broadcast/.windsurf/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "E:/watsaap broadcast/.windsurf/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "E:/watsaap broadcast/.windsurf/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "E:/watsaap broadcast/.windsurf/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
