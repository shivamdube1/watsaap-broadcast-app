...
See E:/watsaap broadcast/.gemini/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using E:/watsaap broadcast/.gemini/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using E:/watsaap broadcast/.gemini/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from E:/watsaap broadcast/.gemini/get-shit-done/templates/discovery.md
...
Use E:/watsaap broadcast/.gemini/get-shit-done/templates/discovery.md.
