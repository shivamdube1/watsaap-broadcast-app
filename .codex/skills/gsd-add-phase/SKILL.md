...
<execution_context>
@E:/watsaap broadcast/.codex/get-shit-done/workflows/add-phase.md
</execution_context>
...
<process>
**Follow the add-phase workflow** from `@E:/watsaap broadcast/.codex/get-shit-done/workflows/add-phase.md`.
