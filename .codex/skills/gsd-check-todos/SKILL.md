...
<execution_context>
@E:/watsaap broadcast/.codex/get-shit-done/workflows/check-todos.md
</execution_context>
...
<process>
**Follow the check-todos workflow** from `@E:/watsaap broadcast/.codex/get-shit-done/workflows/check-todos.md`.
