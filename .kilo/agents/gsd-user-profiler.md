...
<reference>
@E:/watsaap broadcast/.kilo/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `E:/watsaap broadcast/.kilo/get-shit-done/references/user-profiling.md` to load:
