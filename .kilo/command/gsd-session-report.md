...
<execution_context>
@E:/watsaap broadcast/.kilo/get-shit-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @E:/watsaap broadcast/.kilo/get-shit-done/workflows/session-report.md end-to-end.
</process>
