...
<required_reading>
@E:/watsaap broadcast/.claude/get-shit-done/references/continuation-format.md
</required_reading>
...
```bash
INIT=$(node "E:/watsaap broadcast/.claude/get-shit-done/bin/gsd-tools.cjs" init resume)
