...
<reference>
@E:/watsaap broadcast/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `E:/watsaap broadcast/.claude/get-shit-done/references/user-profiling.md` to load:
